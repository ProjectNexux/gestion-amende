    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-slate-500">{conducteur.civilite ?? ""} {conducteur.prenom} {conducteur.nom}</p>
        </div>
      ...
      <form action={updateConducteur.bind(null, conducteur.id)} className="space-y-6 card p-5">
        <section className="space-y-3">
          <h2 className="text-sm font-semibold text-slate-700">Informations principales</h2>
        ...
        <section className="space-y-3 border-t border-slate-100 pt-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-md border border-slate-200 p-3">
              <div className="text-sm font-medium text-slate-700">Recto</div>
            ...
            <div className="rounded-md border border-slate-200 p-3">
              <div className="text-sm font-medium text-slate-700">Verso</div>
